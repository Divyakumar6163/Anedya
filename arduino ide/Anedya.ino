...
// Provide your connection key, that you can get from the node details section
const char *CONNECTION_KEY = ddc54139d5a90fcb182afa45d01a110c;
const char *PHYSICAL_DEVICE_ID = 6a7c968b-4c94-4a91-8e89-71b5e88bd1ab;
// Wifi ssid and password
const char *SSID = "Divya Kumar";
const char *PASSWORD = "Divyakumar+5161";
